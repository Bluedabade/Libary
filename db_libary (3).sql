...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2025 at 01:54 PM
...
INSERT INTO `tb_book` (`id`, `b_id`, `b_name`, `b_writer`, `b_category`, `b_price`, `b_img`) VALUES
(1, 'B00001', 'คู่มือการสอบรับราชการ', 'สมศักดิ์ ตั้งใจ', 1, 299, 'Cream and Black Simple Elegant Catering Food Logo.png'),
(2, 'B00002', 'แฮร์รี่ พอตตเตอร์', 'J.K. Rowling', 2, 359, 'e78c907e6f67f0aa4763b0436ffc3ea0-depositphotos-bgremover.png'),
(3, 'B00003', 'เย็บ ปัก ถักร้อย', 'สะอาด อิ่มสุข', 3, 249, 'png-clipart-muffin-banana-free-content-cartoon-bananas-food-fruit.png'),
(4, 'B00004', 'เจ้าชายน้อย', 'อ็องตวน เดอ แซ็ง', 2, 355, 'book_67cc33770238c.png'),
(5, 'B00005', 'การเขียนโปรแกรมคอมพิวเตอร์', 'กิ่งแก้ว กลิ่่นหอม', 1, 329, 'book_67cc338142cac.jpg'),
(8, 'B00006', 'คู่มือการสอบตำรวจ', 'สมศักดิ์ ตั้งใจ', 4, 500, 'frame (1).png');
